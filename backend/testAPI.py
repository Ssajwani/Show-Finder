...
import api
api1 = api.AnimeAPI("../Data/animes.csv")
...
class APITester (unittest.TestCase):
    def test_valid_genre(self):
        ...
        self.assertEqual(result, ["Choujuu Giga", "True Love Story", "Suki Desu Suzuki-kun!!", "Sekishoku Elegy", "Monogatari no Aru Satou", "Koitabi: True Tours Nanto", "Nemuranu Machi no Cinderella: Hirose Ryouichi - Memorial Date", "Ushinawareta Mirai wo Motomete: Ushinawareta Natsuyasumi wo Motomete", "To Heart 2 AD Plus", "Kagami", "Steady x Study", "Koikishi Purely☆Kiss The Animation: Special Edition", "Ai (ONA)", "Wedding Park", "Amagami SS+ Plus Specials"])
    ...
    def test_valid_score_exact_match(self):
        ...
        result_1 = api1.getTitleofAnimefromScore("8.65")
        result_2 = api1.getTitleofAnimefromScore("9.23")
        result_3 = api1.getTitleofAnimefromScore("8.28")
        self.assertEqual(result_1, ["Fate/stay night Movie: Heavens Feel - II. Lost Butterfly", "Death Note"])
        self.assertEqual(result_2, ["Fullmetal Alchemist: Brotherhood"])
        self.assertEqual(result_3, ["Kaguya-hime no Monogatari", "High Score Girl II", "Yahari Ore no Seishun Love Comedy wa Machigatteiru. Zoku", "xxxHOLiC Kei", "Trigun", "Toki wo Kakeru Shoujo", "Romeo no Aoi Sora", "Ouran Koukou Host Club", "Mobile Suit Gundam: The Origin", "Major S4", "InuYasha: Kanketsu-hen", "Cardcaptor Sakura Movie 2: Fuuin Sareta Card", "Bakuman."])
    ...
    def test_valid_input_of_episodes(self):
        ...
        self.assertEqual(result_1, ["Hong Mao Lan Tu: Konglong Shijie", "Manga Kotowaja Jiten", "Mahoutsukai Sally 2"])
